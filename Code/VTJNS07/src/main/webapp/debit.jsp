...
<div class="sidebar">
    ...
    <a href="debit.jsp" class="active">Debit</a>
    ...
    <div class="container">
        ...
        <form action="Debit" method="post">
            <table>
                ...
                <tr><td>Withdraw Amount:</td><td><input type="number" name="damount" required></td></tr>
                <tr><td><button type="submit">Withdraw</button></td></tr>
            </table>
        </form>
